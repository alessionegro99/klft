...
inline void write_common_observable_sample(std::ofstream &file) {
  file << "GaugeObservableParams:\n"
       ...
       << "  dirichlet_correlator_max_r: 0\n"
       << "  boundary_wilson_max_r: 0\n"
  ...
  file << "  W_Lmu_Lnu_pairs:\n"
       ...
       << "  dirichlet_holonomy_correlator_filename: \"dirichlet_holonomy_correlator.out\"\n"
       << "  dirichlet_holonomy_summary_filename: \"dirichlet_holonomy_summary.out\"\n"
       << "  dirichlet_plaquette_profile_filename: \"dirichlet_plaquette_profile.out\"\n"
       << "  boundary_wilson_loop_filename: \"boundary_wilson_loop.out\"\n"
       << "  dirichlet_bulk_polyakov_filename: \"dirichlet_bulk_polyakov.out\"\n"
